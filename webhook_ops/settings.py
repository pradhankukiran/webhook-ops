...
env = environ.Env(
    ...
    WEBHOOKOPS_TUNNEL_AUTH_TOKEN=(str, "dev-auth-token"),
...
MIDDLEWARE = [
    ...
    "webhook_ops.auto_login.AutoLoginAsSuperuserMiddleware",
...
WEBHOOKOPS_TUNNEL_AUTH_TOKEN = env("WEBHOOKOPS_TUNNEL_AUTH_TOKEN")
